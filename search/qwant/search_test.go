...
package qwantsearch_test

import (
	"testing"

	qwantsearch "github.com/tminaorg/brzaguza/search/brave"
)
...
func TestSearch(t *testing.T) {
	...
	opts := qwantsearch.SearchOptions{
		Limit: 20,
	}
	...
	returnLinks, err := qwantsearch.Search(nil, q, opts)
	if err != nil {
