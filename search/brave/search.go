...
const stdBase = "https://search.brave.com/search?q="
...
func Search(ctx context.Context, searchTerm string, opts ...SearchOptions) ([]Result, error) {
	...
	c.OnHTML("div#results > div", func(e *colly.HTMLElement) {

		sel := e.DOM

		linkHref, _ := sel.Find("a").Attr("href")
		linkText := strings.TrimSpace(linkHref)
		titleText := strings.TrimSpace(sel.Find("a > span.snippet-title").Text())
		descText := strings.TrimSpace(sel.Find("div.snippet-content > p").Text())
