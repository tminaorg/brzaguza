...
const stdBase = "https://www.startpage.com/sp/search?q="
...
func Search(ctx context.Context, searchTerm string, opts ...SearchOptions) ([]Result, error) {
	...
	c.OnHTML("div.w-gl__result", func(e *colly.HTMLElement) {

		sel := e.DOM

		linkHref, _ := sel.Find("a.w-gl__result-url").Attr("href")
		linkText := strings.TrimSpace(linkHref)
		titleText := strings.TrimSpace(sel.Find("a.w-gl__result-title > h3").Text())
		descText := strings.TrimSpace(sel.Find("p.w-gl__description").Text())
