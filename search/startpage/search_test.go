...
package startpagesearch_test

import (
	"testing"

	startpagesearch "github.com/tminaorg/brzaguza/search/startpage"
)
...
func TestSearch(t *testing.T) {
	...
	opts := startpagesearch.SearchOptions{
		Limit: 20,
	}
	...
	returnLinks, err := startpagesearch.Search(nil, q, opts)
	if err != nil {
