...
package duckduckgosearch_test

import (
	"testing"

	duckduckgosearch "github.com/tminaorg/brzaguza/search/duckduckgo"
)
...
func TestSearch(t *testing.T) {
	...
	opts := duckduckgosearch.SearchOptions{
		Limit: 20,
	}
	...
	returnLinks, err := duckduckgosearch.Search(nil, q, opts)
	if err != nil {
